...
function M.LoadConfig(get_mod_config)
    ...
    local cfg = {
        ...
        BOSS_AFFIX_CHANCE = Get("BOSS_AFFIX_CHANCE") or 0.4,
    }
...
MergeDefs(require("rogue/defs/drop_balance_defs"))
MergeDefs(require("rogue/defs/boss_balance_defs"))
