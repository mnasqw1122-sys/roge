...
-- [V2.3] 日常任务额外奖励规则（材料/装备部分），按任务类型配置
M.DAILY_REWARD_RULES = {
    [1] = { mat_base = 1, gear_rolls = 1, gear_chance = 0.10 },
    [2] = { mat_base = 2, gear_rolls = 1, gear_chance = 0.15 },
    [3] = { mat_base = 3, gear_rolls = 2, gear_chance = 0.25 },
    [4] = { mat_base = 1, gear_rolls = 1, gear_chance = 0.10 },
    [5] = { mat_base = 2, gear_rolls = 1, gear_chance = 0.20 },
    [6] = { mat_base = 2, gear_rolls = 1, gear_chance = 0.20 },
    [7] = { mat_base = 1, gear_rolls = 1, gear_chance = 0.15 },
    [8] = { mat_base = 1, gear_rolls = 1, gear_chance = 0.10 },
    [9] = { mat_base = 1, gear_rolls = 1, gear_chance = 0.10 },
    [10] = { mat_base = 2, gear_rolls = 1, gear_chance = 0.15 },
    [11] = { mat_base = 2, gear_rolls = 1, gear_chance = 0.20 },
    [12] = { mat_base = 2, gear_rolls = 1, gear_chance = 0.20 },
    [13] = { mat_base = 2, gear_rolls = 1, gear_chance = 0.15 },
    [14] = { mat_base = 2, gear_rolls = 1, gear_chance = 0.20 },
    [15] = { mat_base = 3, gear_rolls = 2, gear_chance = 0.30 },
}
...
-- [V2.3] 多人协作系统数据（coop_system.lua 期望结构：buffs 数组 + proximity_range）
M.COOP_BUFF_DEFS = {
    proximity_range = 12,
    buffs = {
        { id = "damage", name = "协力强攻", desc = "附近有队友时伤害提升", bonus = 0.05, min_allies = 1, max_stack = 3 },
        { id = "defense", name = "并肩坚守", desc = "附近有队友时受到伤害降低", bonus = 0.03, min_allies = 1, max_stack = 3 },
        { id = "speed", name = "同频疾行", desc = "附近有队友时移速提升", bonus = 0.05, min_allies = 1, max_stack = 2 },
        { id = "regen", name = "互助疗愈", desc = "附近有队友时缓慢恢复生命", bonus = 0.4, min_allies = 2, max_stack = 2 },
    },
}

-- [V2.3] 复活互助消耗：施救者支付 25% 最大生命 + 25 理智
M.COOP_REVIVE_COST = {
    health_pct = 0.25,
    sanity_cost = 25,
}
...
-- [V2.3] 协作事件定义（守护据点）
M.COOP_EVENT_DEFS = {
    { id = "guard_point", name = "守护据点", desc = "坚守据点30秒，抵御围攻，结束后附近玩家获得材料与装备奖励" },
}
