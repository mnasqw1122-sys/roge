...
M.ELITE_AFFIX_DEFS = {
    ...
    -- [V3 扩展] 精英词缀补充
    { id = "bloodthirst", name = "渴血", hp_mult = 1.05, dmg_mult = 1.3, speed_mult = 1.1, lifesteal = 0.15, weight = 1 },
    { id = "crystal", name = "晶化", hp_mult = 1.5, dmg_mult = 0.95, speed_mult = 0.9, weight = 1 },
}
...
M.AFFIX_CONFLICTS = {
    ...
    -- [V3 扩展] 新词缀冲突规则
    bloodthirst = { vampire = true, drain = true },
    crystal = { berserk = true, swift = true },
}

-- [V3 扩展] Boss 专属词缀
-- 仅可附加到 Boss 级别实体（min_day 控制解锁天数，weight 控制权重）
M.BOSS_AFFIX_DEFS = {
    { id = "boss_berserk", name = "怒涛", desc = "血量低于50%时进入狂暴，伤害+40%持续10秒", hp_mult = 1.1, dmg_mult = 1.15, min_day = 20, weight = 3 },
    { id = "boss_doppel", name = "残影", desc = "每30秒分裂一个自身镜像，镜像拥有50%属性", hp_mult = 1.2, dmg_mult = 1.0, min_day = 25, weight = 2 },
    { id = "boss_drain_field", name = "汲取领域", desc = "攻击时吸取目标生命并降低其治疗", hp_mult = 1.25, dmg_mult = 1.05, min_day = 28, weight = 2 },
    { id = "boss_armor", name = "不灭战甲", desc = "受到的伤害减少25%，但行动稍缓", hp_mult = 1.4, dmg_mult = 0.95, speed_mult = 0.9, min_day = 22, weight = 2 },
    { id = "boss_phase_3", name = "三重暴走", desc = "血量低于30%时召唤精英护卫并狂暴", hp_mult = 1.15, dmg_mult = 1.2, min_day = 35, weight = 1 },
}
...
M.ENVIRONMENT_AFFIX_DEFS = {
    ...
    -- [V3 扩展] 环境词缀
    { id = "meteor_shower", name = "陨石雨", desc = "每12秒随机落下陨石，造成范围伤害", weight = 1, min_day = 30, duration = 70 },
    { id = "soul_drain_mist", name = "噬魂迷雾", desc = "全体玩家生命与理智缓慢流失，但击杀敌人回复", weight = 1, min_day = 26, duration = 90 },
}
...
M.GLOBAL_AFFIX_DEFS = {
    ...
    -- [V3 扩展] 全局词缀
    { id = "boss_gauntlet", name = "Boss连战", desc = "Boss波次额外召唤1名Boss，但掉落提升", weight = 1, min_day = 32 },
    { id = "combo_boost", name = "连击风暴", desc = "玩家连击持续时间+50%", weight = 1, min_day = 16 },
}
