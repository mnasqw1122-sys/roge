...
-- 池查询缓存：按 {type, day} 缓存过滤后的池快照
-- 避免每次GetRuntimePool都重新遍历过滤
local _pool_cache = {}
local _pool_cache_variant = nil
...
catalog.POOLS = {
    ...
    ENEMIES_NORMAL = {
        -- 基础群体
        { prefab = "spider",            weight = 81, count = {1, 2}, min_day = 0 },  -- 蜘蛛
        { prefab = "killerbee",         weight = 70, count = {2, 3}, min_day = 0 },  -- 杀人蜂
        { prefab = "mosquito",          weight = 46, count = {2, 3}, min_day = 0 },  -- 蚊子
        { prefab = "frog",              weight = 52, count = {1, 2}, min_day = 0 },  -- 青蛙
    ...
    -- [精英敌人池 - 标准版] (通常单只生成，但属性极高)
    -- 分组内排序规则：先按 min_day 升序，再按 weight 降序
    ENEMIES_ELITE = {
        -- 体型/野外首领级
        { prefab = "koalefant_summer",  weight = 35,  min_day = 10 }, -- 考拉象(夏)
        { prefab = "leif",              weight = 40,  min_day = 15 }, -- 树精守卫
        { prefab = "leif_sparse",       weight = 40,  min_day = 15 }, -- 稀疏树精守卫
        { prefab = "koalefant_winter",  weight = 35,  min_day = 20 }, -- 考拉象(冬)
    ...
    DROPS_BOSS_GEAR = {
        ...
        { prefab = "ruins_bat",         weight = 40, tags = {"burst"}, tier_hint = "mid" }, -- 铥矿棒
        { prefab = "eyebrellahat",      weight = 40, tags = {"utility"}, tier_hint = "mid" }, -- 眼球伞
        ...
        { prefab = "panflute",          weight = 30, tags = {"control"}, tier_hint = "mid" }, -- 排箫
        ...
        { prefab = "hivehat",           weight = 20, tags = {"utility"}, tier_hint = "late" }, -- 蜂后头
        { prefab = "trident",           weight = 20, tags = {"burst", "utility"}, tier_hint = "late" }, -- 远古叉戟
        { prefab = "krampus_sack",      weight = 10, tags = {"utility"}, tier_hint = "late" }, -- 坎普斯背包
    ...
    ENEMIES_NORMAL_SHIPWRECKED = {
        ...
        { prefab = "flup",              weight = 70, count = {1, 2}, min_day = 2 }, -- 弗拉普(毒鱼蛙)
        { prefab = "crocodog",          weight = 85, count = {1, 2}, min_day = 3 }, -- 鳄犬
        { prefab = "mosquito_poison",   weight = 60, count = {2, 3}, min_day = 5 }, -- 毒蚊子
        { prefab = "watercrocodog",     weight = 65, count = {1, 2}, min_day = 8 }, -- 水鳄犬
        { prefab = "sharx",             weight = 55, count = {1, 1}, min_day = 10 }, -- 猎鲨
        { prefab = "stungray",          weight = 45, count = {1, 2}, min_day = 14 }, -- 电鳐
    ...
    ENEMIES_ELITE_SHIPWRECKED = {
        ...
        { prefab = "poisoncrocodog",    weight = 50, min_day = 14 }, -- 毒鳄犬
        { prefab = "swordfish",         weight = 50, min_day = 18 }, -- 剑鱼
        { prefab = "knightboat",        weight = 45, min_day = 20 }, -- 蒸汽骑士船
        { prefab = "leif_palm",         weight = 35, min_day = 28 }, -- 椰树树精
        { prefab = "whale_blue",        weight = 30, min_day = 20 }, -- 蓝鲸
        { prefab = "whale_white",       weight = 25, min_day = 30 }, -- 白鲸
    },
    ...
    DROPS_NORMAL_SHIPWRECKED = {
        ...
        { prefab = "blubber",           weight = 40, count = {1, 2} }, -- 鲸脂
        { prefab = "tar",               weight = 30, count = {1, 2} }, -- 焦油
        { prefab = "dorsalfin",         weight = 15, count = {1, 1} }, -- 背鳍
        ...
        { prefab = "footballhat",       weight = 50 }, -- 橄榄球头盔
        { prefab = "armorwood",         weight = 50 }, -- 木甲
        { prefab = "machete",           weight = 40 }, -- 砍刀

        -- 工具
        { prefab = "palmleaf_umbrella", weight = 30 }, -- 棕榈叶伞
        { prefab = "bottlelantern",     weight = 20 }, -- 玻璃瓶灯
        { prefab = "boatrepairkit",     weight = 20 }, -- 修船套件
        { prefab = "trap",              weight = 30 }, -- 陷阱
    },
    ...
    DROPS_BOSS_GEAR_SHIPWRECKED = {
        ...
        -- 防具
        { prefab = "armorseashell",     weight = 45, tags = {"tank", "poison"}, tier_hint = "mid" }, -- 贝壳甲
        { prefab = "armor_snakeskin",   weight = 40, tags = {"tank", "water"}, tier_hint = "mid" }, -- 蛇皮甲
        { prefab = "armorlimestone",    weight = 35, tags = {"tank", "heavy"}, tier_hint = "mid" }, -- 石灰岩甲
        { prefab = "armorobsidian",     weight = 24, tags = {"tank", "fire"}, tier_hint = "late" }, -- 黑曜石盔甲
        { prefab = "armor_windbreaker", weight = 30, tags = {"utility", "wind"}, tier_hint = "late" }, -- 防风衣
        { prefab = "blubbersuit",       weight = 25, tags = {"utility", "water"}, tier_hint = "late" }, -- 鲸脂服

        -- 帽子
        { prefab = "snakeskinhat",      weight = 35, tags = {"utility", "water"}, tier_hint = "mid" }, -- 蛇皮帽
        { prefab = "captainhat",        weight = 30, tags = {"utility"}, tier_hint = "mid" }, -- 船长帽
        { prefab = "piratehat",         weight = 30, tags = {"utility"}, tier_hint = "mid" }, -- 海盗帽
        { prefab = "shark_teethhat",    weight = 25, tags = {"utility"}, tier_hint = "late" }, -- 鲨鱼齿帽
        { prefab = "double_umbrellahat",weight = 25, tags = {"utility", "water"}, tier_hint = "late" }, -- 双层伞帽
        { prefab = "gashat",            weight = 25, tags = {"utility", "poison"}, tier_hint = "late" }, -- 防毒帽
        { prefab = "oxhat",             weight = 20, tags = {"utility", "poison"}, tier_hint = "late" }, -- 水牛帽
        ...
        { prefab = "ox_flute",          weight = 20, tags = {"control"}, tier_hint = "late" }, -- 水牛角排箫
    },
    ...
    DROPS_BOSS_MATS_SHIPWRECKED = {
        ...
        { prefab = "tigereye",          weight = 30, count = {1, 1}, tags = {"boss", "craft"}, tier_hint = "late" }, -- 虎眼
        { prefab = "turbine_blades",    weight = 30, count = {1, 1}, tags = {"boss", "craft"}, tier_hint = "late" }, -- 涡轮叶片
        { prefab = "quackenbeak",       weight = 25, count = {1, 1}, tags = {"boss", "craft"}, tier_hint = "late" }, -- 海妖喙
        ...
        { prefab = "snakeskin",         weight = 45, count = {1, 2}, tags = {"craft"}, tier_hint = "mid" }, -- 蛇皮
        { prefab = "dubloon",           weight = 30, count = {2, 4}, tags = {"currency"}, tier_hint = "mid" }, -- 金币
        { prefab = "blubber",           weight = 35, count = {1, 3}, tags = {"craft"}, tier_hint = "mid" }, -- 鲸脂

        -- 通用稀有材料
        { prefab = "gears",             weight = 50, count = {1, 2}, tags = {"craft"} }, -- 齿轮
        { prefab = "nightmarefuel",     weight = 40, count = {2, 4}, tags = {"nightmare", "craft"} }, -- 噩梦燃料
        { prefab = "healingsalve",      weight = 50, count = {1, 2} }, -- 治疗药膏
        { prefab = "bandage",           weight = 40, count = {1, 2} }, -- 蜂蜜药膏
    },
    ...
    ENEMIES_NORMAL_HAMLET = {
        ...
        { prefab = "antman",            weight = 80, count = {2, 3}, min_day = 2 }, -- 蚁人
        { prefab = "rabid_beetle",      weight = 75, count = {2, 3}, min_day = 2 }, -- 狂犬甲虫
        { prefab = "pl_frog",           weight = 55, count = {1, 2}, min_day = 6 }, -- 毒蛙
        ...
        { prefab = "pog",               weight = 40, count = {2, 3}, min_day = 5 }, -- 波格犬
        { prefab = "gnat",              weight = 35, count = {3, 5}, min_day = 8 }, -- 蚊虫
        { prefab = "grabbing_vine",     weight = 30, count = {1, 2}, min_day = 10 }, -- 抓人藤
    },

    -- [哈姆雷特版精英敌人池]
    ENEMIES_ELITE_HAMLET = {
        { prefab = "antman_warrior",    weight = 55, min_day = 12 }, -- 蚁人战士
        { prefab = "pigman_royalguard", weight = 45, min_day = 14 }, -- 猪人皇家守卫
        { prefab = "pigbandit",         weight = 40, min_day = 16 }, -- 猪人强盗
        { prefab = "hippopotamoose",    weight = 35, min_day = 18 }, -- 河马鹿
        ...
        { prefab = "pangolden",         weight = 20, min_day = 20 }, -- 食金兽
        { prefab = "ancient_robot",     weight = 25, min_day = 30 }, -- 远古机器人
    },
    ...
    DROPS_NORMAL_HAMLET = {
        ...
        { prefab = "bill_quill",        weight = 42, count = {1, 2} }, -- 针鼠刺
        { prefab = "fabric",            weight = 35, count = {1, 2} }, -- 布料
        { prefab = "shears",            weight = 12, count = {1, 1} }, -- 剪刀
        { prefab = "lotus_flower",      weight = 40, count = {1, 2} }, -- 莲花
        { prefab = "teatree_nut",       weight = 35, count = {1, 3} }, -- 茶树坚果
        { prefab = "pigskin",           weight = 40, count = {1, 2} }, -- 猪皮
        ...
        { prefab = "tomato_cooked",     weight = 30,  count = {1, 2} }, -- 烤番茄
        { prefab = "asparagus_cooked",  weight = 30,  count = {1, 2} }, -- 烤芦笋
        { prefab = "aloe_cooked",       weight = 40,  count = {1, 2} }, -- 烤芦荟
        { prefab = "radish_cooked",     weight = 40,  count = {1, 2} }, -- 烤萝卜
        { prefab = "jellybug_cooked",   weight = 40,  count = {1, 2} }, -- 烤果冻虫
        { prefab = "slugbug_cooked",    weight = 40,  count = {1, 2} }, -- 烤鼻涕虫
        { prefab = "lotus_flower_cooked",weight= 40,  count = {1, 2} }, -- 烤莲花
        { prefab = "coffeebeans_cooked",weight = 40,  count = {1, 2} }, -- 烤咖啡豆
    ...
    DROPS_BOSS_GEAR_HAMLET = {
        ...
        { prefab = "cork_bat",          weight = 40, tags = {"burst"}, tier_hint = "mid" }, -- 软木蝙蝠棒
        ...
        { prefab = "living_artifact",   weight = 20, tags = {"burst", "transform"}, tier_hint = "late" }, -- 活体神器
        { prefab = "walkingstick",      weight = 25, tags = {"utility", "tempo"}, tier_hint = "late" }, -- 拐杖
        ...
        { prefab = "pithhat",           weight = 30, tags = {"utility", "water"}, tier_hint = "mid" }, -- 木髓帽
        { prefab = "bathat",            weight = 25, tags = {"utility"}, tier_hint = "late" }, -- 蝙蝠帽
        { prefab = "pigcrownhat",       weight = 20, tags = {"utility"}, tier_hint = "late" }, -- 猪皇冠
        { prefab = "thunderhat",        weight = 20, tags = {"utility"}, tier_hint = "late" }, -- 雷帽
        { prefab = "bandithat",         weight = 20, tags = {"utility"}, tier_hint = "late" }, -- 强盗帽
        { prefab = "candlehat",         weight = 20, tags = {"utility"}, tier_hint = "late" }, -- 蜡烛帽
        { prefab = "disguisehat",       weight = 15, tags = {"utility"}, tier_hint = "late" }, -- 伪装帽
    ...
    DROPS_BOSS_MATS_HAMLET = {
        ...
        { prefab = "venus_stalk",       weight = 30, count = {1, 1}, tags = {"boss", "craft"} }, -- 捕蝇草茎
        ...
        -- 遗物系列
        { prefab = "relic_1",           weight = 15, count = {1, 1}, tags = {"rare", "trade"} }, -- 遗物1
        { prefab = "relic_2",           weight = 12, count = {1, 1}, tags = {"rare", "trade"} }, -- 遗物2
        { prefab = "relic_3",           weight = 10, count = {1, 1}, tags = {"rare", "trade"} }, -- 遗物3
...
function catalog.SetWorldVariant(variant)
    local new_variant = variant
    if variant ~= "shipwrecked" and variant ~= "hamlet" then
        new_variant = "standard"
    end
    -- 世界变体变更时清空缓存
    if catalog.world_variant ~= new_variant then
        catalog.world_variant = new_variant
        _pool_cache = {}
        _pool_cache_variant = new_variant
    end
end
...
-- 函数说明：清空池查询缓存（配置热更新时调用）
function catalog.ClearCache()
    _pool_cache = {}
end

-- 函数说明：根据天数和类型，动态构建当前的随机权重池
-- 使用缓存避免重复过滤，仅在天数或类型变化时重新计算
function catalog.GetRuntimePool(type, day)
    -- 检查缓存有效性
    if _pool_cache_variant ~= catalog.world_variant then
        _pool_cache = {}
        _pool_cache_variant = catalog.world_variant
    end

    local cache_key = type .. "_" .. tostring(day)
    local cached = _pool_cache[cache_key]
    if cached then
        return cached.pool, cached.total_weight
    end
    ...
    if not raw_list then return {}, 0 end
    ...
    -- 写入缓存
    _pool_cache[cache_key] = { pool = pool, total_weight = total_weight }
